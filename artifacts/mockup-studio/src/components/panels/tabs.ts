import { LayoutGrid, Smartphone, Image as ImageIcon, Sliders, Sun, Type, Layers, Blend } from 'lucide-react';
import type { LucideProps } from 'lucide-react';

export type Tab = 'presets' | 'device' | 'background' | 'canvas' | 'lighting' | 'text' | 'template' | 'overlay';
