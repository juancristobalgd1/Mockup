...
export const PATTERNS: PatternOption[] = [
  ...
  },
  {
    ...
    bgStyle: (bgColor: string, patternColor: string) => ({
      backgroundColor: bgColor,
      backgroundImage: `linear-gradient(135deg, ${hexToRgba(patternColor, 0.12)} 25%, transparent 25%), linear-gradient(225deg, ${hexToRgba(patternColor, 0.12)} 25%, transparent 25%), linear-gradient(45deg, ${hexToRgba(patternColor, 0.12)} 25%, transparent 25%), linear-gradient(315deg, ${hexToRgba(patternColor, 0.12)} 25%, transparent 25%)`,
  ...
  },
  {
    ...
    bgStyle: (bgColor: string, patternColor: string) => ({
      backgroundColor: bgColor,
      backgroundImage: `radial-gradient(circle at 50% 0, transparent 45%, ${hexToRgba(patternColor, 0.15)} 46%, ${hexToRgba(patternColor, 0.15)} 54%, transparent 55%), radial-gradient(circle at 50% 100%, transparent 45%, ${hexToRgba(patternColor, 0.15)} 46%, ${hexToRgba(patternColor, 0.15)} 54%, transparent 55%)`,
      backgroundSize: '20px 20px',
  ...
  },
  {
    ...
    label: 'Noise',
    bgStyle: (bgColor: string, patternColor: string) => {
      let h = patternColor.startsWith('#') ? patternColor.slice(1) : 'ffffff';
      if (h.length === 3) h = h.split('').map(c => c + c).join('');
      ...
      return {
        backgroundColor: bgColor,
        backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='4' stitchTiles='stitch'/%3E%3CfeColorMatrix type='matrix' values='0 0 0 0 ${r} 0 0 0 0 ${g} 0 0 0 0 ${b} 0 0 0 1 0'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.15'/%3E%3C/svg%3E")`,
  ...
  },
  {
    ...
    bgStyle: (bgColor: string, patternColor: string) => ({
      backgroundColor: bgColor,
      backgroundImage: `repeating-radial-gradient(circle at center, ${hexToRgba(patternColor, 0.15)}, ${hexToRgba(patternColor, 0.15)} 2px, transparent 2px, transparent 30px)`,
  ...
  },
  {
    ...
    bgStyle: (bgColor: string, patternColor: string) => ({
      backgroundColor: bgColor,
      backgroundImage: `repeating-conic-gradient(from 0deg at center, ${hexToRgba(patternColor, 0.15)} 0deg 10deg, transparent 10deg 20deg)`,
      backgroundSize: '100% 100%',
      backgroundPosition: 'center',
      backgroundRepeat: 'no-repeat'
    })
...
export const SOLIDS = [
  '#ffffff', '#f3f4f6', '#d1d5db', '#6b7280', '#374151', '#111827', '#000000',
